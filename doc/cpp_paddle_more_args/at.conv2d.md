## [paddle 参数更多]at::conv2d

### PyTorch C++ API
```cpp
at::conv2d(input, weight, bias={}, stride=1, padding=0, dilation=1, groups=1)
```

### Paddle C++ API
```cpp
paddle::experimental::conv2d(input, filter, strides={1, 1}, paddings={0, 0}, padding_algorithm="EXPLICIT", dilations={1, 1}, groups=1, data_format="NCHW")
```
